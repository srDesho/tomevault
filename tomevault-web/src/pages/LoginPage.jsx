  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-4">
        {/* Demo credentials banner outside login box */}
        <div className="p-3 rounded-lg bg-blue-900 bg-opacity-30 border border-blue-700">
          <div className="flex items-start gap-2">
            <Info className="h-5 w-5 text-blue-400 flex-shrink-0 mt-0.5" />
            <div className="text-sm">
              <p className="text-blue-200 font-semibold mb-1">Cuenta Demo para Prueba</p>
              <p className="text-blue-300 text-xs">
                <span className="font-medium">Usuario:</span> demo | <span className="font-medium">Correo:</span> demo@tomevault.com
              </p>
              <p className="text-blue-300 text-xs">
        ...
        {/* Login box */}
        <div className="bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700 transform transition-all duration-300 hover:scale-[1.02]">
